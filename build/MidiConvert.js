...
/***/ function(module, exports, __webpack_require__) {
	...
	var Track = function () {
	   ...
	   */
			...
			key: 'instrument',
			get: function get() {
				return this.isPercussion ? _instrumentMaps.drumKitByPatchID[this.instrumentNumber] : _instrumentMaps.instrumentByPatchID[this.instrumentNumber];
			},
	   ...
	   */
			...
			get: function get() {
				return this.isPercussion ? 'drums' : _instrumentMaps.instrumentFamilyByID[Math.floor(this.instrumentNumber / 8)];
			}
		}]);
